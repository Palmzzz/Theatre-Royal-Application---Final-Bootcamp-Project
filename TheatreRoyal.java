...
//							orderTotal = concession * quantity;
							...
							booking.addOrderToBasket(ticket);
							booking.addTicketToSoldCollection(quantity);
							orderTotal = connector.printResultSetPriceDouble(price);
...
//						booking.addOrderToBasket(ticket);
//						booking.addTicketToSoldCollection(quantity);
//						int price1 = connector.printResultSetPriceDouble(price);
//						orderTotal = quantity * price1;
//						System.out.println("\n Your ticket was successfully added to basket. Your total basket value is: "
//										+ orderTotal);
						String checkout = reader.getText("\nWould you like to proceed to checkout? Type yes or no");
...
//		System.out.println("Your basket total is " + getOrderTotal());
		...
		if (collect.equals("P") || collect.equals("p")) {
			System.out.println("You have opted to have your tickets posted to your address");
		} else {
			System.out.println("You have opted to collect the tickets on the day");
...
//		System.out.println("Your basket total is " + getOrderTotal());
		...
		if (confirm.equals("y")) {
			...
			System.out.println("Order confirmed. Thank you, we hope you enjoy the show!");
			orderNo++;
			start();
		}
	}
